...
def finder(query):
    ...
    for i in range(len(y)):
        ...
        stat_map_url = f"https://maps.googleapis.com/maps/api/staticmap?center=Edinburgh,UK&zoom=13&scale=1&size=600x600&maptype=roadmap&key=APIKEY&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7C{origin}&markers=size:mid%7Ccolor:0xff0000%7Clabel:2%7C{dest}"
